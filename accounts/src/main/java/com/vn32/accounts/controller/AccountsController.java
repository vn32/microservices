package com.vn32.accounts.controller;
...
@RestController
@RequestMapping(path="/api",produces = {MediaType.APPLICATION_JSON_VALUE})//means path will be api and it will response in json format
//@AllArgsConstructor// if you comment this, will trigger a null pointer exception on each api request
@Validated //means perform all kind of validations applied on api's in this controller
public class AccountsController {
    ...
    //responses this method can throw or give
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
            ...
            @ApiResponse(
                    ...
                    content = @Content( // to mention the correct error type in documentation
    ...
    @Operation(
            ...
            description = "Get java version information that is used to build accounts microservices"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
